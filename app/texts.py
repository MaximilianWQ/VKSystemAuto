...
TAKEN_INTRO = (
    "Здравствуйте! Меня зовут {name}, {role}. "
    "Беру ваше обращение №{id} в работу и скоро вернусь с ответом."
)
TICKET_CLOSED_FULL = (
    "Обращение №{id} закрыто.\n\n"
    "{by}Если вопрос вернётся — просто напишите сюда, откроем новое обращение.\n\n"
    "{rating}"
)
CLOSED_BY = "С вами работал(а) {signature}.\n"
